...
import phongnt.accountInfo.AccountInfoSearchError;
...
public class SearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        AccountInfoSearchError errors = new AccountInfoSearchError();
//        boolean isError = false;
        ...
        try {
                ...
                ArrayList<AccountInfoDTO> searchResult = dao.getAccountList();
